...
@IBDesignable
//render everything below onto main storyboard
...
class Rainbow: UIView {
    ...
    //renders dimentions of the circles
    @IBInspectable var firstCircle: CFloat = 10
    @IBInspectable var secondCircle: CFloat = 50
    @IBInspectable var thirdCircle: CFloat = 90
